...
{
	public class MeawzerSummonProj : ModProjectile
	{
		...
		public override void SetDefaults()
		{
			...
			shoot = ModContent.ProjectileType<MeawzerSummonLazer>();
			shootSpeed = 12f;
		}
		...
		public override void AI()
		{
			...
			{
				player.ClearBuff(ModContent.BuffType<MeawzerSummonBuff>());
			}
			if (player.HasBuff(ModContent.BuffType<MeawzerSummonBuff>()))
			{
