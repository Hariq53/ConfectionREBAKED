...
namespace TheConfectionRebirth.Tiles
{
	...
	public class ConfectionCampfire : ModTile
	{
		...
		public override void NearbyEffects(int i, int j, bool closer)
		{
			...
			if (Main.tile[i, j].TileFrameX < 52 && (int)Vector2.Distance(player.Center / 16f, new Vector2(i + 0.5f, j + 0.5f)) <= 125)
			{
			...
			if (Main.tile[i, j].TileFrameX < 52 && (int)Vector2.Distance(player.Center / 16f, new Vector2(i + 0.5f, j + 0.5f)) <= 3 && player.HeldItem.type == ItemID.MarshmallowonaStick)
			{
