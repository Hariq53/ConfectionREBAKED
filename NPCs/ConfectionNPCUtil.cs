...
namespace TheConfectionRebirth.NPCs
{
	public struct DS
	{
		...
		public static Rectangle DrawFrame(Texture2D tex, int x = 0, int y = 0) => new(x, y, tex.Width, tex.Height);
	...
	public struct Utilities
	{
		...
		public static Color LerpColor(Color c1, Color c2, float lerp) => new(LerpRound(c1.R, c2.R, lerp), LerpRound(c1.G, c2.G, lerp), LerpRound(c1.B, c2.B, lerp), LerpRound(c1.A, c2.A, lerp));
	}
